...
public class ThreadUtil {
	...
	public static void endThread(String threadName) throws IllegalArgumentException {
		if (threadPool.containsKey(threadName)) {
			threadPool.get(threadName).interrupt();
		} else {
			throw new IllegalArgumentException("Invalid thread name provided, " + threadName
					+ " was not found.");
		}
	}
