...
public class TestUtil {
	...
	/**
	 * Determines if any input nodes exist in the network
	 * 
	 * @param networkToCheck
	 *            the network to be checked for input nodes
	 * @return True or False depending on if any input nodes exist
	 */
	...
	/**
	 * Determines if any output nodes exist in the network
	 * 
	 * @param networkToCheck
	 *            the network to be checked for output nodes
	 * @return True or False depending on if any output nodes exist
	 */
	...
	/**
	 * Determines if any hidden nodes exist in the network
	 * 
	 * @param networkToCheck
	 *            the network to be checked for hidden nodes
	 * @return True or False depending on if any hidden nodes exist
	 */
	...
	public static boolean IsSynapseCountProper(NNetwork networkToCheck) {
		boolean isSynapseCountCorrect = networkToCheck.getNetworkSynapses()
				.size() == Math.pow((networkToCheck.getHiddenNodesInNetwork()
				.size() + 1), 2) - 1; // the -1 is needed
										// due to the missing
	...
	/**
	 * Checks to see what kinds (Input, Hidden, Output) nodes exist within the
	...
	/**
	 * Verify that the data in the string is greater then zero. This Helps to
	 * verify that we are not passing empty lines to a node; saving resources
	 * 
	 * @return True or False
	 */
	...
	/*
	 * Warning: Checks from here below are ideas by Craig and may not function
	 * properly yet
	 * 
